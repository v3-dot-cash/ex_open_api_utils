  ...
  configs: [
    %{
      ...
      checks: %{
        ...
        disabled: [
          # Disabled: existing API uses camelCase (is_readOnly?, is_writeOnly?)
          # Changing would be a breaking change
          {Credo.Check.Readability.FunctionNames, []},
          {Credo.Check.Readability.PredicateFunctionNames, []},
          # Disabled: moduledoc not required for all internal modules
          {Credo.Check.Readability.ModuleDoc, []},
          # Disabled: apply is used for dynamic module calls
          {Credo.Check.Refactor.Apply, []},
          # Disabled: nested aliases in tests are fine
          {Credo.Check.Design.AliasUsage, []},
          # Disabled: nesting depth in macro-heavy code
